...
- (void)viewDidLoad {
    ...
    [self.navigationView setTitle:@"导航条动画隐藏(stateBar下停止)"];

    [self.navigationView navigationAnimationScroll:self.tableView criticalPoint:NAV_HEIGHT stopToStateBar:YES];
